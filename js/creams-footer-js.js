 //Oldallapozáshoz
 window.cream = document.getElementById("product-params").getAttribute("page-name")
 //  console.log(cream);
   var currentIcon =  document.getElementById(cream)
 ...
 //Következő termék nyil kattintás
     function nextProduct() {
       ...
       var number = document.getElementById(cream).getAttribute("number");
